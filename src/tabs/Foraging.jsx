...
const Foraging = () => {
  ...
  return (
    <>
      ...
      <Group title="Mushrooms">
        <ToggleButtons data={data.Mushrooms} currentLevel={currentLevel} updateElement={updateElement} />
      </Group>

      <Group title="Plants">
        <ToggleButtons data={data.Plants} currentLevel={currentLevel} updateElement={updateElement} />
      </Group>
